...
part of 'local_parc_model.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class LocalParcAdapter extends TypeAdapter<LocalParc> {
  @override
  final int typeId = 2;

  @override
  LocalParc read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, LocalParc obj) {
    writer
      ..writeByte(33)
      ..writeByte(0)
